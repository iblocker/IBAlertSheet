...
/** 某天30天之前的日期*/
+ (NSDate *)ThirtydaysEaralierThanDate:(NSDate *)date {
    
    NSTimeInterval endToNow = [[NSDate date] timeIntervalSinceDate:date];
    NSTimeInterval startToNow = endToNow + 24*60*60*30;
    
    return [NSDate dateWithTimeIntervalSinceNow:-startToNow];
}

/** 某天30天之后的日期*/
+ (NSDate *)ThirtydaysLaterThanDate:(NSDate *)date {
    
    NSTimeInterval startToNow = [[NSDate date] timeIntervalSinceDate:date];
    NSTimeInterval endToNow = startToNow - 24*60*60*30;
    
    return [NSDate dateWithTimeIntervalSinceNow:-endToNow];
}
